 ...
 * @AUTHOR Baby
 * @CREATE 2019/9/25
 * @DESCRIPTION 根据时间生成UUID
 * @since 1.0.0
 */
public abstract  class UUIDByTimeUtils {
    ...
    static {
        try {
            IS_THREADLOCALRANDOM_AVAILABLE = null != UUIDByTimeUtils.class.getClassLoader().loadClass(
