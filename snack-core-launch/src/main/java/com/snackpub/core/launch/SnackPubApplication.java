 ...
 */
package com.snackpub.core.launch;

import com.snackpub.core.launch.constant.AppConstant;
import com.snackpub.core.launch.constant.NacosConstant;
import com.snackpub.core.launch.constant.SentinelConstant;
import com.snackpub.core.launch.service.LauncherService;
 ...
 * @author Chill
 */
public class SnackPubApplication {
    ...
    public static SpringApplicationBuilder createSpringApplicationBuilder(String appName, Class source, String... args) {
        ...
        String startJarPath = SnackPubApplication.class.getResource("/").getPath().split("!")[0];
        ...
        props.setProperty("snackpub.env", profile);
        props.setProperty("snackpub.name", appName);
        props.setProperty("snackpub.is-local", String.valueOf(isLocalDev()));
        props.setProperty("snackpub.dev-mode", profile.equals(AppConstant.PROD_CODE) ? "false" : "true");
        props.setProperty("snackpub.service.version", AppConstant.APPLICATION_VERSION);
